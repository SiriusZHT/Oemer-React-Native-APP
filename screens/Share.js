        ...
        <Block flex={1}>
          ...
          >
            ...
            <Block margin={[0, 0, 0, width * 0.07]}>
              <Text h1 bold color="primary">Music Submit Success!!!</Text>
            </Block>
            <Block flex={0.2}  margin={[-width * 3.8, 0, 0, width * 0.07]}>
              <Text >Want to share this music?</Text>
              <Input
                style={{ width: width * 0.8 }}
                defaultValue="  Type your post title here 👈🏻"
                onChangeText={(text) => this.setState({ email: text })}
              />
              <Input
                style={{ width: width * 0.8, marginTop: -10}}
                defaultValue="  Type your post content here 👈🏻"
                onChangeText={(text) => this.setState({ email: text })}
              />
              <Button
                gradient
